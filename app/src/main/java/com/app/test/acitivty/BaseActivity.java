...
public abstract class BaseActivity extends Activity {
    ...
    public void fadeIn(View animView, int durationTime, AnimationListener animListener) {
    ...
    public void fadeOut(View animView, int durationTime, AnimationListener animListener) {
